...
diabetes_model = pickle.load(open('C:/Users/admin/Desktop/major project/multiple disease prediction system/saved model/Diabetes_disease_data.sav', 'rb'))

heart_model = pickle.load(open('C:/Users/admin/Desktop/major project/multiple disease prediction system/saved model/heart_disease_data.sav', 'rb'))

parkinsons_model = pickle.load(open('C:/Users/admin/Desktop/major project/multiple disease prediction system/saved model/parkinsons_model.sav', 'rb'))
